...
async function fetchUpdate() {
  try {
    ...
    // Infinite scroll limit removed, show all past updates
  } catch (err) {
...
setInterval(fetchUpdate, 600000);
...
// Get timestamp when update loads
function getLoadedDate() {
  return new Date().toLocaleString();
}

// Create DOM element for new update
...
setInterval(fetchUpdate, 5 * 60 * 1000); // 5 min = 300000 ms
